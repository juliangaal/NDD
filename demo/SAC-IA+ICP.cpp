...
int main(int argc, char** argv)
{
    ...
    pcl::io::loadPCDFile<pcl::PointXYZ>("/home/julian/dev/loop_closure/vorplatz/00300.pcd", *target_cloud);
    ...
    vg_source.setLeafSize(2.0, 2.0, 2.0);
    ...
    vg_target.setLeafSize(2.0, 2.0, 2.0);
